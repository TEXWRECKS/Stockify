        ...
        <Card className="product-card">
          <Card.Body>
            ...
            <Card.Subtitle className="mb-2 text-muted product-subtext">
              Would you like to save this product to your "Saved Products" page for notification capabilities?
            </Card.Subtitle>
            ...
            : counter===1 ?
            <Card.Subtitle className="mb-2 text-muted product-subtext">
              This item has been saved to your Saved Products!  Check your Saved Products page to confirm product notification preferences.
            </Card.Subtitle>
